...
impl<'a> EntryReadAccess<'a> {
    // #[tracing::instrument(name="broker_datapoint")]
    ...
    // #[tracing::instrument(name="broker_metadata")]
...
impl<'a, 'b> DatabaseReadAccess<'a, 'b> {
    ...
    #[tracing::instrument(name="broker_get_metadata_by_id", fields(timestamp=chrono::Utc::now().to_string()))]
    pub fn get_metadata_by_id(&self, id: i32) -> Option<&Metadata> {
        self.db.entries.get(&id).map(|entry| &entry.metadata)
    }

    #[tracing::instrument(name="broker_get_metadata_by_path", fields(timestamp=chrono::Utc::now().to_string()))]
...
impl<'a, 'b> DatabaseWriteAccess<'a, 'b> {
    ...
    #[tracing::instrument(name="broker_update_entry_lag_to_be_equal", fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_update", fields(timestamp=chrono::Utc::now().to_string()))]
...
impl Database {
    ...
    #[tracing::instrument(name="broker_authorized_read_access", fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_authorized_write_access")]
...
impl<'a, 'b> AuthorizedAccess<'a, 'b> {
    ...
    #[tracing::instrument(name = "broker_get_id_by_path", fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="get_metadata", fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_for_each_entry", skip(f), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name = "broker_update_entries", fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name = "broker_subscribe", fields(timestamp=chrono::Utc::now().to_string()))]
...
impl DataBroker {
    ...
    #[tracing::instrument(name = "broker_authorized_access", fields(timestamp=chrono::Utc::now().to_string()))]
