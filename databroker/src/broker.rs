...
impl Entry {
    #[tracing::instrument(name="broker_diff", skip(self, update), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_validate", skip(self, update), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_validate_allowed_type", skip(self, allowed), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_validate_allowed", skip(self, value), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_validate_value", skip(self, value), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="apply_lag_after_execute", skip(self), fields(timestamp=chrono::Utc::now().to_string()))]
    pub fn apply_lag_after_execute(&mut self) {
        self.lag_datapoint = self.datapoint.clone();
    }

    #[tracing::instrument(name="broker_apply", skip(self, update), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl Subscriptions {
    ...
    #[tracing::instrument(name = "broker_add_change_subscription",skip(self, subscription), fields(timestamp=chrono::Utc::now().to_string()))]    
    pub fn add_change_subscription(&mut self, subscription: ChangeSubscription) {
        self.change_subscriptions.push(subscription)
    }
    #[tracing::instrument(name="broker_notify", skip(self, changed, db))]
    pub async fn notify(
        &self,
    ...
    #[tracing::instrument(name="broker_cleanup", skip(self))]
...
impl QuerySubscription {
    ...
    #[tracing::instrument(name="broker_find_in_db_and_add", skip(self, name, db, input), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_check_if_changes_match", skip(query, changed_origin, db), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_generate_input_list", skip(self, query, db, input), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_generate_input", skip(self, changed, db), fields(timestamp=chrono::Utc::now().to_string()))]
    fn generate_input(
        &self,
        changed: Option<&HashMap<i32, HashSet<Field>>>,
        db: &DatabaseReadAccess,
    ...
    #[tracing::instrument(name="broker_query_subscription_notify", skip(self, changed, db), fields(timestamp=chrono::Utc::now().to_string()))]
    async fn notify(
        &self,
        changed: Option<&HashMap<i32, HashSet<Field>>>,
        db: &Database,
...
impl<'a> EntryReadAccess<'a> {
    #[tracing::instrument(name="broker_datapoint", skip(self), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_metadata", skip(self), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl<'a, 'b> DatabaseReadAccess<'a, 'b> {
    #[tracing::instrument(name="get_entry_by_id", skip(self, id), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_get_metadata_by_id", skip(self, id), fields(timestamp=chrono::Utc::now().to_string()))]
    pub fn get_metadata_by_id(&self, id: i32) -> Option<&Metadata> {
        self.db.entries.get(&id).map(|entry| &entry.metadata)
    }

    #[tracing::instrument(name="broker_get_metadata_by_path", skip(self, path), fields(timestamp=chrono::Utc::now().to_string()))]
    pub fn get_metadata_by_path(&self, path: &str) -> Option<&Metadata> {
        let id = self.db.path_to_id.get(path)?;
        self.get_metadata_by_id(*id)
    }

#[tracing::instrument(name="broker_iter_entries", skip(self), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl<'a, 'b> DatabaseWriteAccess<'a, 'b> {
    ...
    #[tracing::instrument(name="broker_update_entry_lag_to_be_equal", skip(self, path), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_update", skip(self, id, update), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl Database {
    ...
    #[tracing::instrument(name="broker_authorized_read_access", skip(self, permissions), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_authorized_write_access", skip(self, permissions), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl<'a, 'b> AuthorizedAccess<'a, 'b> {
    ...
    #[tracing::instrument(name = "broker_get_id_by_path", skip(self, name) fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="get_metadata", skip(self, id), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name="broker_for_each_entry", skip(self, f), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name = "broker_update_entries",skip(self, updates), fields(timestamp=chrono::Utc::now().to_string()))]
    ...
    #[tracing::instrument(name = "broker_subscribe", skip(self, valid_entries), fields(timestamp=chrono::Utc::now().to_string()))]
...
impl DataBroker {
    pub fn new(version: impl Into<String>) -> Self {
     ...
     #[tracing::instrument(name = "broker_authorized_access",skip(self, permissions), fields(timestamp=chrono::Utc::now().to_string()))]
